...
> 2026-08-31 实施状态：前端成本快照保持、成本事实词典、估算回退标识、单一财务趋势、按需诊断和三段模型核对已实现并发布到桌面 `v0.2.28`。实现与验证证据见 [`2026-08-31 前端成本真实性、模型核对与面板精简开发记录`](./2026-08-31_frontend-cost-truth-panel-simplification-release-report.md)。
