...
本页只描述 v1 `openai.oauth.outbound_transport.v1`。正式桌面 v0.3.0 / 扩展 1.3.0 同时提供 v2 请求预处理和保护传输；新开发者请先阅读[插件开发指南](../../../../docs/PLUGIN_DEVELOPMENT.md)。v1 插件负责建立实际上游 HTTP/TLS 连接，Sub2API 负责账号选择、OAuth Token 生命周期、下游协议、响应解析、SSE、错误映射、用量统计和计费。
