...
- 更新桌面安装包至 `v0.2.37` 可同时获得新界面及内置 `v0.2.5` 内核；独立内核更新不替换旧桌面前端。
...
- 最终通过情况与下载校验记录见 `docs/2026-09-16_development-core-v0.2.5-desktop-v0.2.37-release-report.md`。
